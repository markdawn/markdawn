#include "stdafx.h"
#include "GridDataInterpolate.h"
#include <math.h>

#pragma warning(disable:4244)
GridDataInterpolate::GridDataInterpolate()
{
}
...
int GridDataInterpolate::spline(int end1, int end2, double slope1, double slope2)
{
	int nm1, ib, i, ascend;
	double t;
	nm1 = nin - 1;
...
double GridDataInterpolate::seval(double u)
{
	int i, j, k;
	double w;
	i = last;
...
int GridDataInterpolate::init(double fx[], double fy[], int Iin)
{
	int i;
	flag = 0;
	last = 0;
...
int GridDataInterpolate::interp(int Iin)
{
	int i, n, m, mode;
